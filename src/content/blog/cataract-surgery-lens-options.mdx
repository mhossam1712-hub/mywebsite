export const metadata = {
  ...
  category: 'Cataract',
  image: '/assets/images/og/blog/cataract-surgery-lens-options.png',
...
![Cataract surgery lens options comparison showing monofocal, toric, multifocal, and EDOF lenses](/assets/images/blog/cataract-surgery-lens-options-comparison.webp)
