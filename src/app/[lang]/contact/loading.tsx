  ...
  return (
    <div className="animate-pulse bg-gray-50 py-12 dark:bg-gray-900 md:py-24">
      <div className="mx-auto max-w-2xl px-4">
        <div className="mb-6 h-10 w-1/2 rounded bg-gray-200 dark:bg-gray-800" />
        <div className="space-y-5 rounded-2xl border border-gray-100 bg-white p-6 dark:border-gray-800 dark:bg-gray-950">
