...
const blogArabic = {
  ...
  'lasik-recovery-tips': {
    ...
    description: 'إرشادات عملية للتعافي بعد الليزك في الأسبوع الأول تشمل الراحة والقطرات الموصوفة وإدارة جفاف العين وأوقات الشاشة وعلامات التحذير التي تستدعي التواصل مع الطبيب.',
    category: 'الليزك',
  ...
  'cataract-warning-signs': {
    ...
    description: 'تعرف على أعراض المياه البيضاء المبكرة مثل الزغللة والوهج من الأضواء وبهتان الألوان وصعوبة القيادة ليلاً، ومتى تحجز فحص عيون لدى طبيب متخصص في الإسكندرية.',
    category: 'المياه البيضاء',
  ...
  'dry-eye-screen-time-treatment': {
    ...
    description: 'تعرف على سبب تأثير الشاشات وقلة الرمش في تفاقم جفاف العين والحرقان والزغللة وإجهاد البصر، مع نصائح علاجية ووقائية عملية لتحسين راحة العين أثناء العمل اليومي.',
    category: 'جفاف العين',
